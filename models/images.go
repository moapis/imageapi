...
type Image struct {
	...
	LinkOriginal null.String `boil:"link_original" json:"link_original,omitempty" toml:"link_original" yaml:"link_original,omitempty"`
	LinkResized  null.String `boil:"link_resized" json:"link_resized,omitempty" toml:"link_resized" yaml:"link_resized,omitempty"`
...
var ImageColumns = struct {
	...
	LinkOriginal: "link_original",
	LinkResized:  "link_resized",
}
...
var ImageWhere = struct {
	...
	LinkOriginal whereHelpernull_String
	LinkResized  whereHelpernull_String
}{
	ID:           whereHelperint{field: "\"images\".\"id\""},
	CreatedAt:    whereHelpernull_Time{field: "\"images\".\"created_at\""},
	LinkOriginal: whereHelpernull_String{field: "\"images\".\"link_original\""},
	LinkResized:  whereHelpernull_String{field: "\"images\".\"link_resized\""},
}
...
var (
	imageAllColumns            = []string{"id", "created_at", "link_original", "link_resized"}
	imageColumnsWithoutDefault = []string{"link_original", "link_resized"}
